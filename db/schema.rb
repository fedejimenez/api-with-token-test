...
ActiveRecord::Schema.define(version: 2021_02_07_211612) do
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.jsonb "post_raw_data", default: "{}", null: false
    t.string "status"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_raw_data"], name: "index_tests_on_post_raw_data", using: :gin
  end
